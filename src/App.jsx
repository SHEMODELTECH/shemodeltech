  ...
  <div className="fixed inset-0 bg-white z-50 flex items-center justify-center">
    <div className="text-center px-4">
      ...
      <div className="flex items-center justify-center space-x-2 mb-4 sm:mb-6">
        <div
          className="w-2 h-2 sm:w-3 sm:h-3 bg-pink-600 rounded-full animate-bounce"
...
function App() {
            ...
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route
                  ...
                  element={<Navigate to="/proof-wall" replace />}
                />
                <Route
                  path="/post/:postId"
                  element={
 ...
 certificate in one click or verification is pointless. */}
                ...
                <Route
                  ...
                  element={<Navigate to="/talent-board" replace />}
                />
                ...
                />
                <Route
                  path="/profile/:userEmail/followers"
                  element={<Navigate to="/proof-wall" replace />}
                />
                <Route
                  path="/profile/:userEmail/following"
                  element={<Navigate to="/proof-wall" replace />}
                />
                      ...
                      <div className="max-w-md w-full text-center bg-white rounded-2xl p-8 shadow-md">
                        ...
                        <div className="space-y-3">
                          <button
                            ...
                            className="w-full py-3 px-6 bg-pink-600 hover:bg-pink-700 text-white font-bold rounded-xl transition-all"
                          >
                            Go to Dashboard
                          </button>
                          <button
                            onClick={() => window.history.back()}
                            className="w-full py-3 px-6 bg-gray-100 hover:bg-gray-200 text-gray-900 font-bold rounded-xl border border-gray-300 transition-all"
                          >
                            Go Back
                          </button>
                        </div>
