    ...
    switch (step) {
      ...
      case 4:
        return (
          <div className="space-y-5">
            <div>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-gray-900 mb-1">What will you use She Model Tech for?</h2>
  ...
  return (
    <div className="min-h-screen overflow-x-hidden flex flex-col items-center justify-center px-4 py-8 sm:py-12 bg-white">
      <div className="flex items-center gap-2 mb-8">
        <img src="/Images/512X512.png" alt="She Model Tech" className="w-8 h-8" onError={e => e.target.style.display='none'} />
      ...
      <p className="text-gray-400 text-xs mt-4">{new Date().getFullYear()} She Model Tech. All rights reserved.</p>
    </div>
  );
};
