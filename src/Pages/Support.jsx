...
const Support = () => {
  ...
  const faqs = [
    { q: 'What is She Model Tech?', a: 'She Model Tech is a platform where tech professionals at all levels - from beginners to experts - collaborate on real-world projects, earn TechTalent Badges, and build their professional profile. Think of it as a project-based learning and career acceleration platform.' },
    { q: 'Is She Model Tech free to use?', a: 'Yes, completely, and for everyone. There are no plans, no upgrades, and no paid tier. Every member gets unlimited collaborative projects, all Foundations courses in every track, all six badge tracks, full Talent Board access, unlimited messaging, unlimited job posts, the ability to post paid projects, community and project workspaces, and certificates on completion. Nothing is held back and nothing is metered.' },
