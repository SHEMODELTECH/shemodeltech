...
const Support = () => {
  ...
  const faqs = [
    {
      q: 'What is She Model Tech?',
      a: 'She Model Tech is where women build real tech experience. You join a team of women at different levels, ship a real product over eight weeks, and earn verified badges that show employers exactly what you built.',
    },
    {
      q: 'How does it work?',
    ...
    },
    {
      ...
      a: 'Every badge you earn makes you more visible. Companies have a Top Talent view on the Proof Wall that surfaces members who recently earned badges, linking straight to their profile - and earning your first badge is what lists you on the Talent Board, where hiring companies search for talent.',
    },
    {
      q: 'How do I get the most out of the Proof Wall?',
      a: 'Share regular project updates so hiring companies can see your progress and real work. When you post an update, link your final result - a live site, demo, or published work - rather than your internal workspace, and add an image or screenshot where you can. Consistent, work-focused updates alongside your earned badges are what make hiring companies notice your profile.',
    },
    {
    ...
    },
    {
      ...
      a: 'As a project lead you are responsible for setting up and running the project, not just claiming it. You must provide a project submission link in the workspace Resources tab. A GitHub repository is recommended because it is free and gives the team a place to store code and track work, but you may use another platform of your choice. This submission link is required: it is how the team work is reviewed and how badges are verified on completion. As lead you also coordinate the team in the Discussion tab and mark the project complete when done. Leading earns a TechLeads (Leadership) badge.',
    },
    {
      q: 'What resources should a project lead set up?',
      a: 'At minimum, a submission link (GitHub or similar) where the work lives. You can also add a meeting link (Zoom or Google Meet) for team calls and a project details link such as a Google Doc describing scope and tasks. These live in the workspace Resources tab and help the team collaborate and get the work reviewed.',
    },
    {
    ...
    },
    {
      ...
      a: 'Your final presentation should speak to both technical and non-technical audiences: explain what the project does and why it matters in plain language, and also show the technical depth (architecture, key decisions, code). Deploy the project to a live URL if it is something that should run online, or provide a working prototype if a full deployment is not needed. Your submission folder should clearly include all team members and their roles, the final solution and source code, and any documentation or demo links. The goal is that a reviewer, technical or not, can understand what was built, who built it, and how to see it working.',
    },
    {
    ...
    },
    {
      ...
      a: 'TechDev (Coding Developers), TechArchs (Low/No-Code Developers), TechQA (Quality Testers), TechGuard (Network & Cybersecurity, Cloud & DevOps), TechPO (Product/Project Owners), and TechLeads (Non-Technical Roles). Each has 4 levels: Novice, Associate, Advanced, and Expert.',
    },
    {
    ...
    },
    {
      ...
      a: 'Yes. Go to Settings and toggle Email Visibility on or off. When set to private, your email is hidden from other members. They can still message you through the platform.',
    },
    {
    ...
    },
    {
      ...
      a: 'Use this support form below to report any issues. Include the username, content description, and any screenshots. Our team will review and take action.',
    },
    {
      q: 'Is my data safe?',
      a: 'Yes. All data is stored securely with encrypted connections. See our Privacy Policy for full details.',
    },
  ];
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={sending}
              className="bg-pink-600 hover:bg-pink-700 text-white font-medium text-sm px-6 py-2.5 rounded-lg transition-all disabled:opacity-50"
            >
