...
const TermsOfService = () => {
  const sections = [
    ...
    { title: '10. Membership', content: 'She Model Tech is free to use. There are no membership tiers, no subscription fees, and no paid features - every member has access to projects, Foundations courses, badges, the Talent Board, messaging, job posts, and community features at no cost. We do not charge members for access to the platform. Note that paid projects, where a company pays members for work, are agreements between those parties and are separate from platform access.' },
