...
const LeadApplicationReview = () => {
 ...
 cohort, a project with no lead can&rsquo;t run, and fewer full teams
 ...
 this as a second or third choice, they appear under their
...
const ApplicantPanel = ({ app, project, projects, decided, busy, reviewer, onAct }) => {
 ...
 automatically), click &ldquo;Add Google Meet&rdquo;, save, then
