          ...
          <section className="relative mb-8 xs:mb-10 sm:mb-12 md:mb-16 lg:mb-20 pt-4 xs:pt-6 sm:pt-8 md:pt-12 lg:pt-16">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex items-center justify-center gap-1.5 xs:gap-2 sm:gap-3 mb-4 xs:mb-5 sm:mb-6 md:mb-8 animate-pulse">
                <div className="h-1.5 w-1.5 xs:h-2 xs:w-2 sm:h-3 sm:w-3 md:h-4 md:w-4 bg-blue-400 rounded-full" 
                     ></div>
                <span className="text-blue-500 uppercase tracking-wider xs:tracking-widest text-[10px] xs:text-xs sm:text-sm md:text-base lg:text-lg font-black" 
                      style={{
              ...
              <h1 className="text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black mb-4 xs:mb-5 sm:mb-6 md:mb-8 lg:mb-12 leading-tight tracking-tight px-2"
                ...
                Submit Your{' '}
                <span className="block mt-1 xs:mt-2 sm:mt-3 md:mt-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-blue-500 to-orange-400"
                      style={{
                        textShadow: 'none',
              ...
              <p className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed font-light mb-6 xs:mb-7 sm:mb-8 md:mb-10 lg:mb-12 px-4" 
                ...
                <span className="text-blue-500 font-semibold block sm:inline mt-1 sm:mt-0"> Get access to exclusive opportunities</span> and connect with industry leaders.
              </p>
              
              <div className="h-0.5 xs:h-1 sm:h-1.5 md:h-2 w-12 xs:w-16 sm:w-20 md:w-24 lg:w-32 bg-gradient-to-r from-blue-500 to-orange-400 mx-auto rounded-full shadow-2xl mb-6 xs:mb-8 sm:mb-10 md:mb-12 lg:mb-16"
                   ></div>
            </div>
          </section>
          ...
          <section className="mb-8 xs:mb-10 sm:mb-12 md:mb-16 lg:mb-20">
            <div className="bg-gradient-to-br from-black/40 via-gray-900/40 to-black/40 rounded-xl xs:rounded-2xl sm:rounded-3xl p-4 xs:p-5 sm:p-6 md:p-8 lg:p-10 xl:p-12 border border-white/20 shadow-2xl">
              ...
              {submitStatus === 'success' && (
                <div className="mb-6 xs:mb-7 sm:mb-8 p-4 xs:p-5 sm:p-6 bg-gradient-to-r from-blue-500/12 to-orange-500/12 border border-blue-500/30 rounded-lg xs:rounded-xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 xs:space-y-7 sm:space-y-8">
                ...
                <div className="space-y-4 xs:space-y-5 sm:space-y-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 xs:gap-5 sm:gap-6">
                    {/* First Name */}
                    <div>
                      <label className="block text-blue-500 font-semibold mb-2 xs:mb-3 text-sm xs:text-base sm:text-lg">
                        First Name *
                      </label>
                      <input
                        type="text"
                        ...
                        required
                        className="w-full bg-white/10 border border-white/20 rounded-lg xs:rounded-xl px-3 xs:px-4 sm:px-5 md:px-6 py-2.5 xs:py-3 sm:py-3.5 md:py-4 text-sm xs:text-base text-white placeholder-gray-400 focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400/20 transition-all duration-300"
                ...
                <div className="space-y-4 xs:space-y-5 sm:space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full bg-white/10 border border-white/20 rounded-lg xs:rounded-xl px-3 xs:px-4 sm:px-5 md:px-6 py-2.5 xs:py-3 sm:py-3.5 md:py-4 text-sm xs:text-base text-white placeholder-gray-400 focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400/20 transition-all duration-300 resize-vertical"
                ...
                <div className="space-y-4 xs:space-y-5 sm:space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className="w-full bg-white/10 border border-white/20 rounded-lg xs:rounded-xl px-3 xs:px-4 sm:px-5 md:px-6 py-2.5 xs:py-3 sm:py-3.5 md:py-4 text-sm xs:text-base text-white focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400/20 transition-all duration-300 appearance-none cursor-pointer"
                      style={{
                ...
                <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg xs:rounded-xl p-4 xs:p-5 sm:p-6">
                  <h3 className="text-blue-500 font-bold text-base xs:text-lg mb-3 xs:mb-4">Application Guidelines</h3>
                ...
                <div className="text-center pt-4 xs:pt-6 sm:pt-8">
                  ...
                  >
                    <span className="absolute inset-0 bg-gradient-to-r from-blue-500 to-orange-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 xs:gap-8 sm:gap-10 md:gap-12 lg:gap-16 mb-6 xs:mb-8 sm:mb-10 md:mb-12">
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-1.5 xs:space-y-2 sm:space-y-3">
                <li>
                  <Link to="/" className="text-gray-600 hover:text-blue-400 transition-colors duration-300 text-xs xs:text-sm sm:text-base font-medium"
                        style={{textShadow: '1px 1px 2px rgba(0,0,0,0.8)'}}>
                    Home
                  </Link>
                </li>
                <li>
                  <Link to="/projects" className="text-gray-600 hover:text-blue-400 transition-colors duration-300 text-xs xs:text-sm sm:text-base font-medium"
                        style={{textShadow: '1px 1px 2px rgba(0,0,0,0.8)'}}>
                    Projects
                  </Link>
                </li>
                <li>
                  <Link to="/community" className="text-gray-600 hover:text-blue-400 transition-colors duration-300 text-xs xs:text-sm sm:text-base font-medium"
                        style={{textShadow: '1px 1px 2px rgba(0,0,0,0.8)'}}>
                    Home
                  </Link>
                </li>
                <li>
                  <Link to="/career/contact" className="text-gray-600 hover:text-blue-400 transition-colors duration-300 text-xs xs:text-sm sm:text-base font-medium"
                        style={{textShadow: '1px 1px 2px rgba(0,0,0,0.8)'}}>
                    Hire Talents
                  </Link>
                </li>
            ...
            <div className="text-center sm:text-left sm:col-span-2 md:col-span-1">
              ...
              <ul className="space-y-1.5 xs:space-y-2 sm:space-y-3">
                <li>
                  <Link to="/career/support" className="text-gray-600 hover:text-blue-400 transition-colors duration-300 text-xs xs:text-sm sm:text-base font-medium"
                        style={{textShadow: '1px 1px 2px rgba(0,0,0,0.8)'}}>
                    Support
                  </Link>
                </li>
                <li>
                  <Link to="/career/about" className="text-gray-600 hover:text-blue-400 transition-colors duration-300 text-xs xs:text-sm sm:text-base font-medium"
                        style={{textShadow: '1px 1px 2px rgba(0,0,0,0.8)'}}>
                    About
                  </Link>
                </li>
                <li>
                  <Link to="/career/terms" className="text-gray-600 hover:text-blue-400 transition-colors duration-300 text-xs xs:text-sm sm:text-base font-medium"
                        style={{textShadow: '1px 1px 2px rgba(0,0,0,0.8)'}}>
                    Terms of Service
                  </Link>
                </li>
                <li>
                  <Link to="/career/privacy" className="text-gray-600 hover:text-blue-400 transition-colors duration-300 text-xs xs:text-sm sm:text-base font-medium"
                        style={{textShadow: '1px 1px 2px rgba(0,0,0,0.8)'}}>
                    Privacy Policy
                  </Link>
                </li>
