  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10 sm:py-16">
      ...
      <p className="text-gray-600 text-sm mb-8 leading-relaxed">
        ...
        to apply. We&rsquo;ll have a short chat before assigning leads, because a team is depending
        on whoever takes this on.
      </p>
      ...
      <p className="text-gray-500 text-xs mb-4">
        Pick up to {MAX_RANKED_CHOICES}, in order. If someone else leads your first choice,
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0">
                  <p className="font-semibold text-gray-900 text-sm">{p.projectTitle || p.title}</p>
