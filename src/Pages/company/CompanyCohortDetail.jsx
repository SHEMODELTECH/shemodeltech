...
import {
  applyToCompanyCohort,
  canApplyToCompanyCohort,
  reportParty,
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10 sm:py-14">
      ...
      <div className="flex items-center gap-3 mb-5">
        {cohort.companyLogo && (
          <img
            src={cohort.companyLogo}
            alt=""
            className="w-11 h-11 rounded-lg object-contain bg-gray-50"
          />
        )}
        <div>
      ...
      <div className="flex flex-wrap gap-4 text-sm text-gray-600 mb-8">
        <span>
          <strong className="text-gray-900">Budget:</strong> {formatMoney(cohort.totalBudget)}
        </span>
        {cohort.startDate && (
          <span>
            <strong className="text-gray-900">Starts:</strong> {cohort.startDate}
          </span>
        )}
        <span>
          <strong className="text-gray-900">Target:</strong> {cohort.endDate}
        </span>
      </div>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-8">
        <p className="text-gray-900 text-sm font-bold mb-1">
          This is paid work, not a badge project
        </p>
      ...
      {myApp ? (
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-4">
          <p className="text-gray-900 text-sm font-semibold">You applied for {myApp.roleTitle}</p>
        ...
        {reporting ? (
          <>
            ...
            <div className="flex gap-3">
              ...
              <button onClick={() => setReporting(false)} className="text-gray-500 text-xs">
                Cancel
              </button>
            </div>
          </>
