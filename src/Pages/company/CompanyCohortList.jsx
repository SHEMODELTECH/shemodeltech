  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 sm:py-14">
      ...
      <p className="text-gray-600 text-sm mb-6 leading-relaxed">
        Real companies hiring She Model Tech members for paid work. The company
        owns the project, reviews applications, and pays you directly. These
        don&rsquo;t award badges &mdash; you receive a verified paid
      ...
      {eligibility && !eligibility.allowed && (
        <div className="bg-pink-50 border border-pink-200 rounded-xl p-4 mb-6">
          ...
          <p className="text-gray-600 text-xs mb-2 leading-relaxed">
            Companies hire from our badge holders because a badge means verified,
            commit-backed proof you shipped something on a real team. Have a look
        ...
        {cohorts.map(c => (
          ...
          >
            <div className="flex items-start gap-3">
              {c.companyLogo && (
                <img src={c.companyLogo} alt="" className="w-10 h-10 rounded-lg object-contain bg-gray-50 shrink-0" />
              )}
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="text-gray-500 text-xs">{c.companyName}</span>
                  {c.companyVerified && (
                    <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-full bg-blue-100 text-blue-700 uppercase">
                      Verified
                    </span>
                  )}
                </div>
