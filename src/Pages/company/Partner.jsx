...
const Partner = () => {
 ...
 certificate, a verified badge backed by commit history you can
 ...
 No card needed. Verification is free too, submit your registration
 ...
 or {formatPrice(PLANS.TALENT_ACCESS_ANNUAL.amount, 'year')}, two months free
 </p>
 ...
 decisions and code, that&rsquo;s what makes the training real.
 </p>
 <button
