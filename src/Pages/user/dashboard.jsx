...
const DashboardOverview = () => {
 ...
 <button onClick={() => navigate('/foundations')} className="bg-pink-600 hover:bg-pink-700 text-white text-sm font-semibold px-5 py-2 rounded-lg transition-all">
 Go to Foundations
 </button>
 </div>
 )}
 ...
 <Link to="/projects/submit" className="text-pink-600 text-sm font-medium hover:underline">+ Post Paid Project</Link>
 <Link to="/projects/owner-dashboard" className="text-pink-600 text-sm font-medium hover:underline">Manage</Link>
 </div>
 </div>
 ...
 <button onClick={() => navigate('/projects')} className="bg-pink-600 hover:bg-pink-700 text-white font-semibold text-sm px-5 py-2.5 rounded-lg transition-all">
 Browse Projects
 </button>
 </div>
 ...
 <Link to="/projects/my-projects" className="text-pink-600 text-sm font-medium hover:underline">See All</Link>
 </div>
 ...
 <span className="text-xs font-medium px-2 py-1 bg-pink-50 text-pink-700 rounded-md flex-shrink-0 ml-3">Active</span>
 </div>
 ))}
 </div>
 )}
 ...
 <Link to="/project-vault" className="text-pink-600 text-sm font-medium hover:underline">View All</Link>
 </div>
 ...
 <span className="text-xs font-medium px-2 py-1 bg-pink-50 text-pink-700 rounded-md flex-shrink-0 ml-3">Completed</span>
 </div>
 ))}
 </div>
 )}
 ...
 return (
 <div key={badge.id} className={`flex items-center gap-3 p-3 rounded-lg border ${earned ? 'border-pink-200 bg-pink-50/30' : 'border-gray-100 bg-gray-50/50'}`}>
 ...
 {earned && (
 <span className="text-[10px] font-medium px-1.5 py-0.5 bg-pink-100 text-pink-700 rounded-full">{level}{count > 1 ? ` · ${count}` : ''}</span>
 )}
 </div>
 ...
 <Link to="/account" className="text-pink-600 text-sm font-medium hover:underline">View Account</Link>
 </div>
 <div className="grid grid-cols-2 gap-2 mb-2">
 {profileData?.isCompany ? (
 <>
 <div className="bg-pink-50 border border-pink-200 rounded-lg p-3">
 <p className="text-pink-700 text-[10px] uppercase tracking-wider font-semibold">Disbursed</p>
 <p className="text-lg font-black text-pink-700">{formatMoney(disbursements.disbursedTotal)}</p>
 </div>
 ...
 She Model Tech is free for everyone. Unlimited collaborative projects, all
 Foundations courses, every badge track, the Talent Board, unlimited
 messaging, and the Proof Wall, nothing is held back.
 </p>
 <Link to="/settings?tab=membership" className="text-pink-600 text-sm font-medium hover:underline">
 ...
 <Link to="/talent-board" className="text-pink-600 text-sm font-medium hover:underline">View Talent Board</Link>
 </div>
 </div>
 </div>
 </div>
