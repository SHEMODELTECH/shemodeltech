...
// Helps anyone, a non-tech person curious about tech, or a CS grad who's unsure, // find which of the 6 badge-tracks fits them, based on their background and interests.
...
const DiscoverTrack = ({ onPickTrack }) => {
  ...
  const handleSubmit = () => {
    ...
    const top = ranked.some((t) => t._score > 0)
      ? ranked.filter((t) => t._score > 0).slice(0, 3)
      : TRACKS.slice(0, 3);
    setResults(top);
  };
      ...
      {!results ? (
        <>
          ...
          <p className="text-gray-600 text-sm mb-4">
            New to tech, switching fields, or not sure which role fits you? Tell us a little about
            yourself and we'll point you to the right track and roles.
          </p>

          <label className="block text-sm font-medium text-gray-700 mb-1">
            What's your background or field?
          </label>
          <input
            type="text"
            value={field}
            ...
            className="w-full bg-white border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:border-pink-500 focus:outline-none mb-4"
          />

          <p className="text-sm font-medium text-gray-700 mb-2">
            What kind of work interests you? (pick any)
          </p>
        ...
        <>
          ...
          <p className="text-gray-600 text-sm mb-4">
            Based on what you shared, these tracks suit you best. Each leads to a verified badge as
            you complete real projects.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-4 mt-5">
            <button
              ...
              className="bg-pink-600 hover:bg-pink-700 text-white text-sm font-semibold px-5 py-2 rounded-lg transition-all"
            >
