  ...
  return (
    <div className="bg-white border-2 border-pink-200 rounded-xl p-4 sm:p-5 mb-5">
      ...
      <p className="text-gray-500 text-xs mb-3 leading-relaxed">
        ...
        {daysLeft !== null && daysLeft >= 0 && ` ${daysLeft} day${daysLeft === 1 ? '' : 's'} to the deadline.`}
        {' '}One click is enough &mdash; it just tells us you&rsquo;re still here.
      </p>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          type="button"
          disabled={saving}
          onClick={() => { if (!expanded) { setExpanded(true); return; } submit(false); }}
