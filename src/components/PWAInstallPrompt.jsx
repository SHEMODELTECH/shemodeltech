    ...
    <div className="fixed bottom-3 sm:bottom-4 left-3 right-3 sm:left-4 sm:right-4 md:left-auto md:right-4 md:max-w-sm z-50 animate-slide-up">
      <div className="bg-gradient-to-br from-black/95 via-gray-900/95 to-black/95 border border-orange-500/30 rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6 shadow-2xl">
        <div className="flex items-start gap-2.5 sm:gap-3">
          {/* App Icon */}
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-pink-600 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-white font-bold text-sm sm:text-base mb-1">
              Install She Model Tech
            </h3>
            <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 leading-relaxed">
              Get quick access to projects, the Proof Wall, and your messages from your home screen.
            </p>
            ...
            <div className="flex flex-col xs:flex-row gap-2">
              <button
                ...
                disabled={installing}
                className="bg-pink-600 text-white px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-semibold hover:from-orange-600 hover:to-pink-600 active:from-orange-700 active:to-pink-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center whitespace-nowrap"
