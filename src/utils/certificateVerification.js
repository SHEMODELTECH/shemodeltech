...
const randomBlock = (n) => Array.from(
 { length: n },
...
export const generateCertificateId = () =>
 `SMT-${randomBlock(4)}-${randomBlock(4)}`;

export const verificationUrl = (certificateId) =>
 `${BRAND.url}/verify/${certificateId}`;
...
export const qrCodeUrl = (certificateId, size = 200) =>
 ...
 encodeURIComponent(verificationUrl(certificateId))
 }`;
...
export const createVerificationRecord = async ({
 certificateId, memberName, memberEmail, projectId, projectTitle,
 roleTitle, badges, startDate, endDate, cohortNumber,
}) => {
